...
STATICTOP = STATIC_BASE + 259360;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_main_worked_cpp() } }, { func: function() { ___emscripten_environ_constructor() } });
...
var real__initVideoStream = asm["_initVideoStream"]; asm["_initVideoStream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__initVideoStream.apply(null, arguments);
};
...
var real__mainInit = asm["_mainInit"]; asm["_mainInit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__mainInit.apply(null, arguments);
};

var real__mainPaint = asm["_mainPaint"]; asm["_mainPaint"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__mainPaint.apply(null, arguments);
};
...
var real__putVideoStream = asm["_putVideoStream"]; asm["_putVideoStream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__putVideoStream.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_main_worked_cpp = Module["__GLOBAL__sub_I_main_worked_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_main_worked_cpp"].apply(null, arguments) };
...
var _initVideoStream = Module["_initVideoStream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_initVideoStream"].apply(null, arguments) };
...
var _mainInit = Module["_mainInit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_mainInit"].apply(null, arguments) };
var _mainPaint = Module["_mainPaint"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_mainPaint"].apply(null, arguments) };
...
var _putVideoStream = Module["_putVideoStream"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_putVideoStream"].apply(null, arguments) };
